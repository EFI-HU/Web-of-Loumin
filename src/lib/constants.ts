...
export const SITE_CONFIG = {
  ...
  description: "娄敏的个人网站 - 8年科技创新股权投资经验，专注于产业数字化、企业服务、金融科技等领域的早期创新项目投资。",
  url: "https://loumin.dev",
  ogImage: "https://loumin.dev/og.jpg",
  author: {
    name: "娄敏",
    email: "loumin@outlook.com",
    twitter: "@loumin",
    github: "loumin",
    linkedin: "loumin"
  }
...
export const WORK_EXPERIENCE = [
  ...
  },
  {
    ...
    description: "负责产业数字化、金融科技、汽车交通科技等领域投资，期间交流考察约1500个创新创业项目，参与投资及管理的项目有开选时代、博车网、量化派等；荣获复星集团年度优秀员工。",
    current: false
  },
  {
