               ...
               <div className="max-w-2xl mx-auto">
                 ...
                 >
                   <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                     8年科技创新股权投资经验，专注于产业数字化、企业服务、金融科技等领域的早期创新项目投资
                   </p>
                 </motion.div>
               </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
              拥有8年科技创新股权投资经验和2年创业管理经验，专注于早期创新项目投资
            </p>
          </motion.div>
              ...
              <div className="bg-white dark:bg-slate-800 p-8 rounded-xl shadow-lg">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-slate-700 dark:text-slate-300">loumin@outlook.com</span>
                  </div>
                  <div className="flex items-start">
                    <MapPinIcon className="w-5 h-5 text-blue-600 mr-3 mt-1" />
                    <span className="text-slate-700 dark:text-slate-300">
                      北京市朝阳区望京SOHO塔1 A座47层4701室
                    </span>
                  </div>
                </div>
              </div>
